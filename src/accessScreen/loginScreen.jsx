  ...
  return (
    <section className="flex flex-col gap-8 bg-customgray h-screen md:p-12 lg:flex-row lg:px-16 lg:py-12">
      <div className="flex flex-col justify-between bg-white rounded-2xl shadow-[0px_50px_60px_-20px_#223A2833] w-full h-full md:flex-row">
        {openTab === 'otp' &&
          <OTP openTab={openTab} setOpenTab={setOpenTab} otpEmail={otpEmail} t={t} />}
        {openTab === 'forgotPassword' &&
          <ForgotPassword setOpenTab={setOpenTab} setotpEmail={setotpEmail} t={t} />
        }
        {openTab === 'login' &&
          ...
          < Login
            ...
            i18n={i18n}
            t={t}
            setCurrentLanguage={setCurrentLanguage}   // Make sure this is passed correctly
          />
        ...
        {openTab === 'signup' &&
          ...
          <SignUp openTab={openTab} setOpenTab={setOpenTab}
            t={t} />
        }
